...
class NfcoreTemplate {
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.blue} oooooo     oooo  o8o                        88  88                        .o88o.  o8o  oooo                     ${colors.reset}
            ${colors.blue}  `888.     .8'   `"'                       88 ss 88                       888 `"  `"'  `888                     ${colors.reset}
            ${colors.blue}   `888.   .8'   oooo  oooo d8b  .ooooo.     88__88    oooo d8b  .ooooo.  o888oo  oooo   888   .ooooo.  oooo d8b ${colors.reset}
            ${colors.blue}    `888. .8'    `888  `888""8P d88' `88b      ||      `888""8P d88' `88b  888    `888   888  d88' `88b `888""8P ${colors.reset}
            ${colors.blue}     `888.8'      888   888     888   888     _||_      888     888   888  888     888   888  888ooo888  888     ${colors.reset}
            ${colors.blue}      `888'       888   888     888   888   // || \\\\    888     888   888  888     888   888  888    .o  888     ${colors.reset}
            ${colors.blue}       `8'       o888o d888b    `Y8bod8P'  //      \\\\  d888b    `Y8bod8P' o888o   o888o o888o `Y8bod8P' d888b    ${colors.reset}
